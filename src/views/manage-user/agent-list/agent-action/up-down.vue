<template>
  <div>
    <el-dialog v-el-drag-dialog title="上下分" :visible.sync="dialogFormVisible" width="500px">
      <font size="3">
        给
        <font color="#2196F3">{{ addscoreDigFrm.agentAccount }}</font>
        上下分
      </font>
      <br>
      <br>
      <font size="2">帐号等级: <span style="color:#2196F3">代理</span></font>
      <span style="margin: 0 20px;" />
      <font size="2">账户余额: <span style="color:#2196F3">{{ addscoreDigFrm.aBalance || 0 }}</span></font>
      <br>
      <br>
  ...
  methods: {
    ...
    Ok() {
      ...
      const sendStr = {
        ...
        JsonData: {
          optName: this.addscoreDigFrm.agentAccount,
