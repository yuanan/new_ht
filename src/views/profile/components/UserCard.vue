  ...
  <el-card style="margin-bottom:20px;">
    ...
    <div class="user-profile">
      ...
      <div class="box-center">
        ...
        <div class="user-role text-center text-muted">{{ '欢迎代理' }}</div>
      ...
      <div class="user-skills user-bio-section">
        ...
        <div class="user-bio-section-body">
          <div class="progress-item">
            <span>账号 </span>
            <span>{{ myCenter.userValue[0].name }}</span>
          </div>
          <br>
          <div class="progress-item">
            <span>余额 </span>
            <span>{{ myCenter.userValue[0].ye }}</span>
          </div>
          <br>
          <div class="progress-item">
            <span>占成比 </span>
            <span>{{ myCenter.userValue[0].zcb }}</span>
          </div>
          <br>
          <div class="progress-item">
            <span>洗码比 </span>
            <span>{{ myCenter.userValue[0].xmb }}</span>
          </div>
        </div>
      </div>
    </div>
